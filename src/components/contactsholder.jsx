...
const ContactsHolder = () => {
  return (
    <div className="md:mt-20">
      ...
      <div className="md:mx-40 md:flex md:items-center">
        <div>
          <img
            src={img10}
            alt=""
        ...
        <div className="md:ml-20">
            ...
            <h4 className="md:text-[2.6rem] md:font-bold md:tracking-[.3rem] md:text-[#F4511E]">Bethany Maisie</h4>
          
         
            <p className="md:text-[1.6rem] md:font-semibold md:tracking-wide md:py-3 md:text-[#F4511E]">Property Owner</p>
         
          <div className="md:flex md:items-center">
            <HiOutlineMail className="md:w-8 md:h-8 md:text-[#F4511E]" />
            {/* <a href={`mailto:${recipient}?subject=Property Enquiries`}></a> */}
             <a href={`mailto:undiefidelis@gmail.com?subject=Property Enquiries`} className="md:text-[1.5rem] md:pl-4 md:underline md:underline-offset-4">undiefidelis@gmail.com</a> 
          ...
          <div className=" md:flex md:items-center">
            ...
            <a href="tel:+1-123-456-7890" className="md:text-[1.5rem] md:pl-4">Call</a>
